...
However, if you want to skip directly into the notebooks, start with `README.ipynb` as a top level guide

## Notebook Description

| Notebook             | Description                                                               |
|----------------------|---------------------------------------------------------------------------|
| README               | Top level guidance in which order to read these notebooks                 |
