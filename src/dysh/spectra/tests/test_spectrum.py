...
class TestSpectrum:
    ...
    def test_line_search(self):
        ...
        assert len(tr) == 15
        freq = np.array([1416.8873, 1424.617 , 1424.617 , 1414.898 , 1415.462 , 1416.725 , 1417.696 , 1423.215 , 1423.215 , 1423.215 , 1423.215 , 1425.106 , 1418.1976, 1419.1013, 1430.3802])
        assert np.all(np.isclose(tr["rest_frequency"].data - freq, 0, atol=1e-7))
        freq = np.array([1399.04343877, 1406.6757932 , 1406.6757932 , 1397.07919143, 1397.63608858, 1398.88318273, 1399.84195424, 1405.29144958, 1405.29144958, 1405.29144958, 1405.29144958, 1407.15863488, 1400.33723724, 1401.2295563 , 1412.36641316])
