...
class SpectralAverageMixin:
    ...
    def smooth(self, method="hanning", width=1, decimate=0):
        ...
        method : {'hanning', 'boxcar', 'gaussian'}, optional
            Smoothing method. Minimum match applies.
        ...
        ------
        ValueError
            If no valid smoothing `method` is given or if `width` is less than 1.
        """
...
class ScanBlock(UserList, HistoricalBase, SpectralAverageMixin):
    ...
    @log_call_to_history
    def smooth(self, method="hanning", width=1, decimate=0):  # ScanBlock
        """
        ...
        """
        for scan in self.data:
            scan.smooth(method, width, decimate)
