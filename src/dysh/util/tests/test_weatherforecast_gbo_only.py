...
from dysh.util.weatherforecast import GBTWeatherForecast, GBTForecastScriptInterface
...
class TestWeatherForecastGBO:
    ...
    def test_pr_issues(self):
        ...
        ans = np.array([[5.92553185e+04, 9.00000000e-01, 9.06443144e-03],
                       [5.92553185e+04, 1.40000000e+00, 9.06408900e-03],
                       [5.92553185e+04, 2.10000000e+00, 8.73946199e-03],
                       [5.92553185e+04, 3.00000000e+00, 6.80079334e-03],
                       [5.92553185e+04, 4.00000000e+00, 6.38185744e-03]])

        z=ggc.zenith_opacity(specval=[3.0,4.0,1.4,2.1,0.9]*u.GHz,mjd=f.obstime) # default coeff=True, vartype=Opacity
