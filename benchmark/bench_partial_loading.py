...
def run_benchmarks(datasets, quick=False, use_index_file=True, backend=None):
...
def main():
    ...
    results = run_benchmarks(datasets, quick=args.quick, use_index_file=use_index_file, backend=args.backend)
