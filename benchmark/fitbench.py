...
if __name__ == "__main__":
    ...
    parser.add_argument('--files', '-f', nargs="+", type=str, required=True, help="The input astropy table(s) with the benchmark data. Multiple tables will be concatenated before fit.")
    parser.add_argument('--params','-p', nargs="+", type=str, required=True, help="The parameters to use in the fit.  These must be column names in the table." )
    parser.add_argument('--depvar', '-d', type=str, required=False, default="time", help="The dependent variable to fit. Default is 'time'")
