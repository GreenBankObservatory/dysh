...
from pyqtgraph import GraphicsLayoutWidget, ImageView, InfiniteLine, PlotWidget
...
class MemoryUsage(PlotWidget):
    ...
    def update_mem_use_plot(self):
        ...
        self.hline_fsize = pg.InfiniteLine(
            pos=self.fsize, angle=0, movable=False, label="SDFITS File Size", labelOpts={"color": "r"}
        )
