...
- Overview of dysh
   ...
   - ScanBlock, Scan and Spectrum

.. toctree::
   :maxdepth: 1

   getting_started/index
   users_guide/loading_data
   users_guide/data_contents
   users_guide/retrieving_data.rst
   tutorials/examples/iplotter.html
   tutorials/how-tos/examples/velocity_frames.html
   tutorials/examples/selection.html
   how-tos/examples/flagging.html
   tutorials/examples/frequencyswitch.html
   tutorials/examples/nodding.html
   tutorials/examples/positionswitch.html
   tutorials/examples/subbeamnod.html
   tutorials/examples/calseq.html
   tutorials/examples/vane.html
   how-tos/examples/baseline.html
   how-tos/examples/apeff_surf_error.html
   tutorials/examples/on_the_fly.html
   how-tos/examples/repeated_scans.html
   users_guide/averaging_data
   how-tos/examples/using_spectral_weights.html
   how-tos/examples/smoothing.html
   how-tos/examples/align_spectra.html
   explanations/gauss_fit.html
   explanations/cog
   how-tos/examples/quality.html
   how-tos/examples/line_search.html
   how-tos/examples/metadata_management.html
   how-tos/examples/dataIO.html
   how-tos/examples/merge_sdfits.html
   explanations/sdfits.html
